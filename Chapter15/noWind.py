...
if __name__ == "__main__":
    ...
    env_factories = [
        lambda: gym.make("LunarLander-v2", continuous=True, enable_wind=False, gravity=-5.0)
    ...
    test_env = gym.make("LunarLander-v2", continuous=True, render_mode="rgb_array", enable_wind=False, gravity=-5.0)
    test_env = gym.wrappers.TransformReward(test_env, lambda r: r / 100.0)  # Auch Normalisierung des Rewards normalisieren
    test_env = RecordVideo(env=test_env, video_folder="./video", episode_trigger=lambda x: x % 1000 == 0)
